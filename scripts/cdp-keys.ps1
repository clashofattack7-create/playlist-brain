...
try {
  ...
  [void](Send-Cmd 'Page.enable' @{})
  [void](Send-Cmd 'Runtime.evaluate' @{ expression = "document.getElementById('first') && document.getElementById('first').focus(); 'ok'"; returnByValue = $true })
  Start-Sleep -Milliseconds 400
  foreach ($d in @('8','7','5','1')) {
